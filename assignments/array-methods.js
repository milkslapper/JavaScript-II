...
//  }
runners.forEach(value => console.log(value.first_name + ' '+ value.last_name))
...
//     return {'first_name':state.first_name.toUpperCase()};
// })
//  console.log(allCaps); 

// ==== Challenge 3: Use .filter() ====
// The large shirts won't be available for the event due to an ordering issue.  Get a list of runners with large sized shirts so they can choose a different size. Return an array named largeShirts that contains information about the runners that have a shirt size of L and log the result
// let largeShirts = runners.filter((state) => {
...
// Problem 1
// let allLower = runners.map((state) => {
//     return {'last_name':state.last_name.toLowerCase()};
// })
//  console.log(allLower); 

// // Problem 2
// let smallShirts = runners.filter((state) => {
...
// let allUpper = runners.map((state) => {
//     return {'email':state.email.toUpperCase()};
// })
